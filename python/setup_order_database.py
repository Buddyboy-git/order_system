#!/usr/bin/env python3
"""
Order Entry System - Database Setup
Load products from master_vendor_prices.csv and set up the order entry database
"""
...
class OrderEntryDBSetup:
    def __init__(self):
        # Database connection settings - adjust as needed
        self.db_config = {
            'host': 'localhost',
            'database': 'orders',  # Assuming you have an 'orders' database
    ...
    def create_database_schema(self):
        ...
        try:
            ...
            with open('order_entry_schema.sql', 'r', encoding='utf-8') as file:
    ...
    def create_sample_customer_data(self):
        ...
        for product_id, item_code, description in sample_products:
            ...
            # Add salami abbreviations for testing
            if 'salami' in desc_lower:
                product_abbreviations.extend([
...
def main():
    setup = OrderEntryDBSetup()
    
    print("🚀 Order Entry System Database Setup")
    print("=" * 40)
